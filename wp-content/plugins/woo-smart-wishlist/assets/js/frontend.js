...
(function($) {
    ...
    $(document).on('click touch', '.woosw-manage', function(e) {
        ...
        $.post(woosw_vars.wc_ajax_url.toString().replace('%%endpoint%%', 'woosw_manage_wishlists'), data,
            function(response) {
                woosw_wishlist_hide();
    ...
    $(document).on('click touch', '#woosw_add_wishlist', function(e) {
        ...
        $.post(woosw_vars.wc_ajax_url.toString().replace('%%endpoint%%', 'woosw_add_wishlist'), data,
            function(response) {
                $('#woosw_manage').html(response);
                $('#woosw_wishlist').removeClass('woosw-loaded');
                woosw_popup_loaded();
    ...
    $(document).on('click touch', '.woosw-delete-wishlist', function(e) {
        ...
        if (confirm(woosw_vars.delete_confirm)) {
            ...
            $.post(woosw_vars.wc_ajax_url.toString().replace('%%endpoint%%', 'woosw_delete_wishlist'), data,
                function(response) {
                    $('#woosw_manage').html(response);
                    $('#woosw_wishlist').removeClass('woosw-loaded');
                    woosw_popup_loaded();
    ...
    $(document).on('click touch', '.woosw-view-wishlist', function(e) {
        ...
        $.post(woosw_vars.wc_ajax_url.toString().replace('%%endpoint%%', 'woosw_view_wishlist'), data,
            function(response) {
                woosw_manage_hide();
