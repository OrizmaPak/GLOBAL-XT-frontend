...
jQuery(function(e) {
    ...
    if ("hidden" === Cookies.get(o)) e(".woocommerce-store-notice").hide();
        ...
        e(".woocommerce-store-notice").show(), e(".woocommerce-store-notice__dismiss-link").on("click", function n(i) {
            Cookies.set(o, "hidden", {
                path: "/"
            }), e(".woocommerce-store-notice").hide(), i.preventDefault(), e(".woocommerce-store-notice__dismiss-link").off("click", n).off("keydown", t)
        }).on("keydown", t)
    }
