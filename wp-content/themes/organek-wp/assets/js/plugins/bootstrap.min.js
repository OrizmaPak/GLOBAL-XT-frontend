...
! function(e, t) {
    ...
    var o, a, s = function(e) {
        ...
        v = (document.documentElement.dir, o = {}, a = 1, {
            set: function(e, t, n) {
            ...
            delete: function(e, t) {
                if (void 0 !== e.bsKey) {
                    var n = e.bsKey;
                    n.key === t && (delete o[n.id], delete e.bsKey)
                }
            }
        }),
        m = function(e, t, n) {
    ...
    function C(e, t, n) {
        void 0 === n && (n = null);
        for (var r = Object.keys(e), i = 0, o = r.length; i < o; i++) {
            var a = e[r[i]];
    ...
    function k(e, t, n) {
        var r = "string" == typeof t,
            ...
            o = e.replace(_, ""),
            a = A[o];
        return a && (o = a), j.has(o) || (o = e), [r, i, o]
    }
    ...
    function D(e, t, n, r, i) {
        if ("string" == typeof t && e) {
            ...
            if (f) f.oneOff = f.oneOff && i;
                ...
                var d = T(s, t.replace(y, "")),
                    g = a ? function(e, t, n) {
                        return function r(i) {
                            for (var o = e.querySelectorAll(t), a = i.target; a && a !== this; a = a.parentNode)
                                for (var s = o.length; s--;)
                                    if (o[s] === a) return i.delegateTarget = a, r.oneOff && I.off(e, i.type, n), n.apply(a, [i]);
                            return null
                        }
                    }(e, n, r) : function(e, t) {
                        return function n(r) {
                            return r.delegateTarget = e, n.oneOff && I.off(e, r.type, t), t.apply(e, [r])
                        }
                    }(e, n);
                g.delegationSelector = a ? n : null, g.originalHandler = s, g.oneOff = i, g.uidEvent = d, u[d] = g, e.addEventListener(l, g, a)
            }
        }
    }
    ...
    var I = {
                ...
                if ("string" == typeof t && e) {
                    ...
                    if (void 0 === a) {
                        u && Object.keys(c).forEach((function(n) {
                            ! function(e, t, n, r) {
                                ...
                                Object.keys(i).forEach((function(o) {
                                    if (o.includes(r)) {
                                        var a = i[o];
                                        N(e, t, n, a.originalHandler, a.delegationSelector)
                                    }
                                }))
                            }(e, c, n, t.slice(1))
                        }));
                        ...
                        Object.keys(f).forEach((function(n) {
                            ...
                            if (!l || t.includes(r)) {
                                var i = f[n];
                                N(e, c, s, i.originalHandler, i.delegationSelector)
                            }
                        }))
                    } else {
                        if (!c || !c[s]) return;
            ...
            trigger: function(e, t, n) {
                ...
                var r, i = p(),
                    ...
                    u = !1,
                    f = null;
                return a && i && (r = i.Event(t, n), i(e).trigger(r), l = !r.isPropagationStopped(), c = !r.isImmediatePropagationStopped(), u = r.isDefaultPrevented()), s ? (f = document.createEvent("HTMLEvents")).initEvent(o, l, !0) : f = new CustomEvent(t, {
                    bubbles: l,
                    cancelable: !0
                ...
                })), u && f.preventDefault(), c && e.dispatchEvent(f), f.defaultPrevented && void 0 !== r && r.preventDefault(), f
            }
        },
        S = function() {
            function e(e) {
                e && (this._element = e, m(e, this.constructor.DATA_KEY, this))
            }
        ...
        K = function(e) {
            ...
            return r.close = function(e) {
                ...
                if (e.classList.remove("show"), e.classList.contains("fade")) {
                    var n = u(e);
                    I.one(e, "transitionend", (function() {
    ...
    I.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', K.handleDismiss(new K)), h((function() {
        var e = p();
        if (e) {
            var t = e.fn[P];
            e.fn[P] = K.jQueryInterface, e.fn[P].Constructor = K, e.fn[P].noConflict = function() {
                return e.fn[P] = t, K.jQueryInterface
            }
        }
    }));
    var Q = function(e) {
        ...
        return i(t, e), t.prototype.toggle = function() {
            this._element.setAttribute("aria-pressed", this._element.classList.toggle("active"))
        }, t.jQueryInterface = function(e) {
            return this.each((function() {
                var n = b(this, "bs.button");
    ...
    I.on(document, "click.bs.button.data-api", '[data-bs-toggle="button"]', (function(e) {
        ...
        if (e) {
            var t = e.fn.button;
            e.fn.button = Q.jQueryInterface, e.fn.button.Constructor = Q, e.fn.button.noConflict = function() {
    ...
    var q = function(e) {
        ...
        U = function(e) {
            function t(t, n) {
                var r;
                (r = e.call(this, t) || this)._isTransitioning = !1, r._config = r._getConfig(n), r._triggerArray = M('[data-bs-toggle="collapse"][href="#' + t.id + '"],[data-bs-toggle="collapse"][data-bs-target="#' + t.id + '"]');
                for (var i = M('[data-bs-toggle="collapse"]'), o = 0, a = i.length; o < a; o++) {
                    var s = i[o],
                        c = l(s),
                        u = M(c).filter((function(e) {
                            return e === t
                        }));
                    null !== c && u.length && (r._selector = c, r._triggerArray.push(s))
                }
            ...
            return o.toggle = function() {
                ...
                if (!this._isTransitioning && !this._element.classList.contains("show")) {
                    var n, r;
                    this._parent && 0 === (n = M(".show, .collapsing", this._parent).filter((function(t) {
                    ...
                    if (n) {
                        ...
                        if ((r = o ? b(o, "bs.collapse") : null) && r._isTransitioning) return
                    }
                    if (!I.trigger(this._element, "show.bs.collapse").defaultPrevented) {
                        n && n.forEach((function(e) {
                            i !== e && t.collapseInterface(e, "hide"), r || m(e, "bs.collapse", null)
                        }));
                        ...
                        I.one(this._element, "transitionend", (function() {
                            e._element.classList.remove("collapsing"), e._element.classList.add("collapse", "show"), e._element.style[a] = "", e.setTransitioning(!1), I.trigger(e._element, "shown.bs.collapse")
                        })), d(this._element, l), this._element.style[a] = this._element[s] + "px"
                    }
                }
            }, o.hide = function() {
                var e = this;
                    ...
                    if (n > 0)
                        for (var r = 0; r < n; r++) {
                            var i = this._triggerArray[r],
                                o = c(i);
                            o && !o.classList.contains("show") && (i.classList.add("collapsed"), i.setAttribute("aria-expanded", !1))
                        }
                ...
                return f(t) ? void 0 === t.jquery && void 0 === t[0] || (t = t[0]) : t = Y(t), M('[data-bs-toggle="collapse"][data-bs-parent="' + t + '"]', t).forEach((function(t) {
                    var n = c(t);
                ...
                var i = b(e, "bs.collapse"),
                    o = r({}, B, q(e), "object" == typeof n && n ? n : {});
    ...
    I.on(document, "click.bs.collapse.data-api", '[data-bs-toggle="collapse"]', (function(e) {
        ...
        M(n).forEach((function(e) {
            var n, r = b(e, "bs.collapse");
            r ? (null === r._parent && "string" == typeof t.parent && (r._config.parent = t.parent, r._parent = r._getParent()), n = "toggle") : n = t, U.collapseInterface(e, n)
        }))
    })), h((function() {
        var e = p();
        if (e) {
            var t = e.fn[R];
            e.fn[R] = U.jQueryInterface, e.fn[R].Constructor = U, e.fn[R].noConflict = function() {
                return e.fn[R] = t, U.jQueryInterface
            }
        }
    }));
    ...
    var z = function(e) {
        ...
        return r.show = function() {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains("active") || this._element.classList.contains("disabled"))) {
                ...
                if (r) {
                    var i = "UL" === r.nodeName || "OL" === r.nodeName ? ":scope > li > .active" : ".active";
                    t = (t = M(i, r))[t.length - 1]
                }
                var o = null;
                if (t && (o = I.trigger(t, "hide.bs.tab", {
                    ...
                    var a = function() {
                        ...
                        }), I.trigger(e._element, "shown.bs.tab", {
                            relatedTarget: t
                        })
                    };
            ...
            var r = this,
                i = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? H(t, ".active") : M(":scope > li > .active", t))[0],
            ...
            if (i && o) {
                var s = u(i);
                i.classList.remove("show"), I.one(i, "transitionend", a), d(i, s)
            } else a()
        }, r._transitionComplete = function(e, t, n) {
            if (t) {
                t.classList.remove("active");
                var r = Y(":scope > .dropdown-menu .active", t.parentNode);
                r && r.classList.remove("active"), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)
            }
            e.classList.add("active"), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), g(e), e.classList.contains("fade") && e.classList.add("show"), e.parentNode && e.parentNode.classList.contains("dropdown-menu") && (e.closest(".dropdown") && M(".dropdown-toggle").forEach((function(e) {
                return e.classList.add("active")
            })), e.setAttribute("aria-expanded", !0)), n && n()
        }, t.jQueryInterface = function(e) {
            return this.each((function() {
                var n = b(this, "bs.tab") || new t(this);
                if ("string" == typeof e) {
    ...
    return I.on(document, "click.bs.tab.data-api", '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]', (function(e) {
        e.preventDefault(), (b(this, "bs.tab") || new z(this)).show()
    })), h((function() {
        var e = p();
        if (e) {
            var t = e.fn.tab;
            e.fn.tab = z.jQueryInterface, e.fn.tab.Constructor = z, e.fn.tab.noConflict = function() {
                return e.fn.tab = t, z.jQueryInterface
            }
        }
    })), h((function() {
        p()
