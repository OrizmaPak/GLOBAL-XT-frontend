									...
									<div class="elementor-element elementor-element-583b2a0 elementor-hidden-tablet elementor-hidden-phone elementor-widget elementor-widget-image"
										...
										<div class="elementor-widget-container">
											<a href="/globalxt/index.html">
												<img decoding="async" width="150" height="48" style="width:97px" src="../wp-content/uploads/new/logo.png" class="attachment-large size-large wp-image-35010" alt="" /> 
											</a>
										</div>
									</div>
								</div>
														...
														<div class="elementor-widget-container">
															<div class="tm-header-top-info ">
																<ul>
																	<li>
																		<a
																			href="https://wp2022.kodesolution.com/cdn-cgi/l/email-protection#8ae3e4ece5caeff2ebe7fae6efa4e9e5e7">
																			<i aria-hidden="true"
																				class="fas fa-envelope"></i> <span
																				class="__cf_email__"
																				data-cfemail="5b32353d341b3e233a362b373e75383436">[email&#160;protected]</span></a>
																	</li>
																	<li>
																		<a href='tel:+440-98-5298'>
																			<i aria-hidden="true"
															...
															<div class="icon-box-wrapper">
																...
																<div class="icon-text">
																	...
																	<h5 class="icon-box-title ">
																		Visit Us </h5>
																	<div class="content"><a
																			href="https://wp2022.kodesolution.com/cdn-cgi/l/email-protection"
																			class="__cf_email__"
																			data-cfemail="9bd5fefefff3fef7ebdbfff4f6faf2f5b5f8f4f6">[email&#160;protected]</a>
																	</div>
														...
														<div
															...
															<div class="icon-box-wrapper">
																...
																<div class="icon-text">
																	...
																	<h5 class="icon-box-title ">
																		Call Now </h5>
																	<div class="content">+00 1122 3333 1122</div>
